...
function swap(para1, para2, multiplier) {
    ...
    // Calculate the initial positions of the elements
    let para1Left = para1.getBoundingClientRect().left;
    let para2Left = para2.getBoundingClientRect().left;

    // Move the elements to their new positions
    para1.style.transform = `translate(${computedDist - (para1Left - para2Left)}px, 0) rotate(360deg)`;
    para2.style.transform = `translate(${neg + (para1Left - para2Left)}px, 0) rotate(360deg)`;
}
